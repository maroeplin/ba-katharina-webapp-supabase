  ...
  return (
    ...
    <div className="w-full ">
      ...
      >
        ...
        <h1 className="text-2xl text-center">Vielen Dank für die Registrierung. Du erhältst deinen <span className="font-bold">Anmelde-Code mit einer SMS</span> an deine Mobilnummer gesendet.</h1>
        )
     }
